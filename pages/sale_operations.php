...
<div class="row">
     <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
         <div class="page-header">
             <h2 class="pageheader-title">Sale Form</h2>
             <div class="page-breadcrumb">
                 <nav aria-label="breadcrumb">
                     <ol class="breadcrumb">
                         ...
                         <li class="breadcrumb-item active" aria-current="page">Sale Form</li>
                     </ol>
                 </nav>
             </div>
         </div>
        ...
        <div class="row">
			...
			<div class="form-group">
				...
				<div class="row">
					<div class="col-sm-4">
					    <div class="form-group">
                            <label for="" class="form-label" style="font-size: 18px ">customer_name</label>
							<select name="customer_name" id="customer_name" class="form-control" style="color:black; padding:25.5px 20px;">
							</select>
                        </div>
					</div>
					<div class="col-sm-4">
					    <div class="form-group">
                            <label for="" class="form-label" style="font-size: 18px ">customer_phone</label>
                            <input id="customer_phone" name="customer_phone" type="number" class="form-control p-3" disabled>
                        </div>
					</div>
					<div class="col-sm-4">
					    <div class="form-group">
                            <label for="" class="form-label" style="font-size: 18px ">customer_address</label>
                            <input id="customer_address" name="customer_address" type="text" class="form-control p-3" disabled>
                        </div>
					</div>
				</div>
				<div class="row">
