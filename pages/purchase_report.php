             ...
             <div class="page-breadcrumb">
                 <nav aria-label="breadcrumb">
                     <ol class="breadcrumb">
                         ...
                         <li class="breadcrumb-item active" aria-current="page">Purchase Reports</li>
                     </ol>
                 </nav>
             </div>
         </div>
...
<div class="row">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="card">
              <h5 class="card-header">Purchase Reports</h5>
              <div class="card-body">
			  <form id="purchaseReport">
...
include './footer.php';
?>
<script src="../js/purchase_report.js"></script>
